                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-3">
                                    <label for="inputFatherName" class="form-label">
                                        Father Name<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="text" class="form-control" id="inputFatherName" name="father_name" placeholder="Father Name" required>
                                </div>

                                <div class="col-3">
                                    <label for="inputFatherPhone" class="form-label">
                                        Father's Phone<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="text" class="form-control" id="inputFatherPhone" name="father_phone" placeholder="+880 01......" required>
                                </div>

                                <div class="col-3">
                                    <label for="inputMotherName" class="form-label">
                                        Mother Name<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="text" class="form-control" id="inputMotherName" name="mother_name" placeholder="Mother Name" required>
                                </div>

                                <div class="col-3">
                                    <label for="inputMotherPhone" class="form-label">
                                        Mother's Phone<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone" placeholder="+880 01......" required>
                                </div>

                                <div class="col-4">
                                    <label for="inputParent_email" class="form-label">
                                        Parent Email<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="email"
                                           name="parent_email"
                                           id="inputParent_email"
                                           class="form-control"
                                           value="{{ old('parent_email') }}"
                                           placeholder="name+id@smartschool.com"
                                           required>
                                    {{-- لو بدكها اختيارية، احذف required --}}
                                </div>

                                <div class="col-4">
                                    <label for="inputParent_password" class="form-label">
                                        Parent Password<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
                                    <input type="password"
                                           name="parent_password"
                                           id="inputParent_password"
                                           class="form-control"
                                           placeholder="********"
                                           required>
                                    {{-- لو بدكها اختيارية، احذف required --}}
                                ...
                                <div class="col-4">
                                    <label for="inputParentAddress" class="form-label">
                                        Address<sup><i class="bi bi-asterisk text-primary"></i></sup>
                                    </label>
