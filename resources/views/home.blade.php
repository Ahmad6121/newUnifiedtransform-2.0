                    ...
                    <div class="row align-items-md-stretch mt-4">
                        ...
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                ...
                                <p class="text-end">with <i class="bi bi-lightning"></i> <a href="https://www.ju.edu.jo/Home.aspx" target="_blank" style="text-decoration: none;">The University of Jordan</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
