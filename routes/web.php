...
use App\Http\Controllers\ParentDashboardController; // 🆕 لإضافة واجهة الأهل
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth'])
        ...
        ->group(function () {
            ...
            // صفحة Progress (ممكن تطورها لاحقاً)
            Route::get('/progress', [ParentDashboardController::class, 'progress'])
                ->name('progress');

            // قائمة الأبناء
            Route::get('/children', [UserController::class, 'getMyChildren'])
                ->name('children');
        });
